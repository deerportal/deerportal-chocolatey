...
$packageArgs = @{
  ...
  softwareName  = 'deerportal*'  #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
$classic_shortcut = Join-Path ([System.Environment]::GetFolderPath('CommonPrograms')) 'Deer Portal.lnk'
